...
import template from "./mediaWithTagsDetails.html";
...
@Component({
    selector: "media-with-tags-details-workshop",
    template: template
})
export class MediaWithTagsDetailsWorkshop {
    ...
    @Param()
    public readonly mediaItem: MediaWithTagsItem;
    ...
    public async onMounted(): Promise<void> {
        ...
        this.mediaItem.tags.subscribe(this.updateMedia);
    }
