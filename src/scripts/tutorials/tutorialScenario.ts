module Paperbits.Tutorials {
    import IHtmlEditor = Paperbits.Editing.IHtmlEditor;
    import IViewManager =  Paperbits.Ui.IViewManager;
    ...
    export class TutorialScenario {
        ...
        constructor(tutorial: Tutorial, eventManager: IEventManager, viewManager: IViewManager, htmlEditor: IHtmlEditor) {
